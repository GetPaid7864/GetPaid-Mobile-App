...
import '../../proposalSection/screens/submit_a_proposal_Screen.dart';

class JobSeekerJobDetailsScreen extends StatefulWidget {
  final dynamic recentJob;

  const JobSeekerJobDetailsScreen({Key? key, required this.recentJob})
      : super(key: key);

  @override
  State<JobSeekerJobDetailsScreen> createState() =>
      _JobSeekerJobDetailsScreenState();
}

class _JobSeekerJobDetailsScreenState extends State<JobSeekerJobDetailsScreen> {
  @override
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                widget.recentJob.postedBy!.name.toString(),
                                style: fontW7S12(context)!.copyWith(
                              ...
                              Text(
                                widget.recentJob.postedBy!.email.toString(),
                                style: fontW7S12(context)!.copyWith(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recentJob.postedBy!.stars!.length
                                  .toString(),
                              style: fontW7S12(context)!.copyWith(
                                  fontWeight: FontWeight.w700, fontSize: 14),
                            ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (widget.recentJob.checkIn == true) ...[
                    Text(
                      "Requires Check-In",
                      style: fontW7S12(context)!.copyWith(
                          fontWeight: FontWeight.w700,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                    itemCount: widget.recentJob.skills!.length,
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    widget.recentJob.skills![index].toString(),
                                    style: fontW7S12(context)!.copyWith(
                                        fontWeight: FontWeight.w700,
                                        fontSize: 11),
                                  ),
