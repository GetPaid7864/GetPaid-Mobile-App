...
class JobSeekerReviewCardWidget extends StatelessWidget {
  final Review review;

  const JobSeekerReviewCardWidget({Key? key, required this.review})
      : super(key: key);
                ...
                Row(
                  children: [
                    CacheNetworkImageWidget(
                      imgUrl: review.recruiters!.name.toString(),
                      radius: 13,
                      height: 50,
                      width: 50,
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          review.recruiters!.name.toString(),
