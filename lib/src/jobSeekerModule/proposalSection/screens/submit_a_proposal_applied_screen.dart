...
class SubmitProposalAppliedScreen extends StatefulWidget {
  ...
  @override
  State<SubmitProposalAppliedScreen> createState() =>
      _SubmitProposalAppliedScreenState();
}

class _SubmitProposalAppliedScreenState
    extends State<SubmitProposalAppliedScreen> {
                                ...
                                if (formKey.currentState!.validate()) {
                                  jobSeekerProposalProvider
                                      .sendCreateJobRequest(
                                          widget
                                              .applied.jobDetails!.postedBy!.id
                                              .toString(),
                                          widget.applied.jobDetails!.id
                                              .toString(),
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: RichText(
                              ...
                              text: widget.applied.jobDetails!.description
                                  .toString(),
                            ))
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.applied.jobDetails!.status
                                        .toString(),
                                    ...
                                    style: fontW7S12(context)!.copyWith(
                                      ...
                                      color: widget.applied.jobDetails!.status
                                                  .toString() ==
                                              "Active"
                                          ? AppColors.appcolor
                                          : AppColors.redColor,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.applied.jobDetails!.workplace
                                        .toString(),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.applied.jobDetails!.jobLocation
                                        .toString(),
