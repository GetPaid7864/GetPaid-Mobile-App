...
class RecruiterForgotPasswordScreen extends StatefulWidget {
  static String routeName = "ForgotPasswordScreen";

  const RecruiterForgotPasswordScreen({Key? key}) : super(key: key);

  @override
  State<RecruiterForgotPasswordScreen> createState() =>
      _RecruiterForgotPasswordScreenState();
}

class _RecruiterForgotPasswordScreenState
    extends State<RecruiterForgotPasswordScreen> {
