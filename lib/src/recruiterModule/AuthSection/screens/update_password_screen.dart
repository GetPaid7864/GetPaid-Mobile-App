...
class RecruiterUpdatePasswordScreen extends StatefulWidget {
  ...
  const RecruiterUpdatePasswordScreen({Key? key}) : super(key: key);

  @override
  State<RecruiterUpdatePasswordScreen> createState() =>
      _RecruiterUpdatePasswordScreenState();
}

class _RecruiterUpdatePasswordScreenState
    extends State<RecruiterUpdatePasswordScreen> {
