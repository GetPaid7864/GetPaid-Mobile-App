            ...
            children: [
              CountryCodePicker(
                onChanged: (countryCode) {
                  authProvider.countryPicked = countryCode.dialCode;
              ...
              Expanded(
                ...
                child: TextFormField(
                  ...
                  onChanged: (val) {
                    authProvider.userNumber = "+92$val";

                    var countryCode = authProvider.countryPicked ?? "+92";
                    authProvider.completeUserNumber = "$countryCode$val";

                    dp(
                        msg: "complete user number",
                        arg: authProvider.completeUserNumber);
                    // authProvider.userNumber =
                    //     authProvider.countryPicked + val;
                    dp(msg: "phone number", arg: authProvider.userNumber);
                  },
