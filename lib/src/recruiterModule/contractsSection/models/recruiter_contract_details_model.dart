...
RecruiterContractDetailsModel recruiterContractDetailsModelFromJson(
        String str) =>
    RecruiterContractDetailsModel.fromJson(json.decode(str));

String recruiterContractDetailsModelToJson(
        RecruiterContractDetailsModel data) =>
...
class RecruiterContractDetailsModel {
  ...
  factory RecruiterContractDetailsModel.fromJson(Map<String, dynamic> json) =>
      RecruiterContractDetailsModel(
        data: json["data"] == null
            ? []
