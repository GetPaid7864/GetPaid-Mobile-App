...
class DashBoardJobCardsWidget extends StatefulWidget {
  final Active active;

  const DashBoardJobCardsWidget({
    Key? key,
    required this.active,
  }) : super(key: key);

  @override
  State<DashBoardJobCardsWidget> createState() =>
      _DashBoardJobCardsWidgetState();
}

class _DashBoardJobCardsWidgetState extends State<DashBoardJobCardsWidget> {
  @override
