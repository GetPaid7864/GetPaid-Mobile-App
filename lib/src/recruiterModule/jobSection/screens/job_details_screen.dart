                        ...
                        Expanded(
                            child: CommonButtonWidget(
                                ...
                                onTap: () {
                                  toNext(
                                      context: context,
                                      widget: RecruiterEditJobScreen(
                                        jobID: widget.active.jobId.toString(),
                                      ));
                                }))
                      ],
                    ),
            ...
            body: SingleChildScrollView(
              child: recruiterJobsProvider.recruiterJobDetailsModel == null
                  ...
                  : Consumer<RecruiterJobsProvider>(
                      builder: (context, recruiterJobProvider, __) {
                      return Column(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: DashboaedCardWidget(
                                    count:
                                        widget.active.totalProposals.toString(),
                                    text: "Proposals",
                                    onTap: () {
                                      toNext(
                                          context: context,
                                ...
                                Expanded(
                                  flex: 5,
                                  child: DashboaedCardWidget(
                                    count: widget.active.totalShortlisted
                                        .toString(),
                                    text: "Short Listed",
                                    onTap: () {},
