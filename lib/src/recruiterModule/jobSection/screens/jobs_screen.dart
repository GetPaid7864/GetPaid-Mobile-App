...
class JobScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: Consumer<RecruiterDashBoardProviders>(
          builder: (context, recruiterDashboardProvider, __) {
        return LoadingOverlay(
          isLoading: recruiterDashboardProvider.isLoading,
          opacity: 0.1,
          ...
          child: Scaffold(
            body: recruiterDashboardProvider
                        .recruiterDashBoardModel!.dashboardData ==
                    null
                ? const SpinKitPulse(
                    size: 32,
                    color: AppColors.appcolor,
                      ...
                      child: Column(
                        children: [
                          ...
                          CommonButtonWidget(
                            ...
                            onTap: () {
                              toNext(
                                  context: context, widget: PostAJobScreen());
                            },
