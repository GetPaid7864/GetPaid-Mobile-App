                          ...
                          child: CommonButtonWidget(
                              ...
                              onTap: () {
                                if (_formKey.currentState!.validate()) {
                                  recruiterJobsProvider.sendCreateJobRequest(
                                      "",
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: TextFieldWidget(
                              ...
                              showSuffixIcon: true,
                              hintText:
                                  recruiterJobsProvider.selectedDate == null
                                      ? "Select Date"
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  recruiterJobsProvider.selectEndTime(context);
                                },
                                child: TextFieldWidget(
                                    controller: timeFrameController,
                                    textFieldHeight: 55,
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Switch(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    recruiterJobsProvider.isSwitched = value;
                                    dp(
                                        msg: "require check in status",
                                        arg: recruiterJobsProvider.isSwitched);
                                  });
                                },
                              ),
                            ),
                        ...
                        InkWell(
                          ...
                          child: TextFieldWidget(
                              ...
                              enabled: false,
                              hintText:
                                  recruiterJobsProvider.selectedOption == null
                                      ? "Please Choose"
                        ...
                        InkWell(
                          onTap: () {
                            showCountryPicker(
                              ...
                              onSelect: (Country country) {
                                ...
                                setState(() {
                                  recruiterJobsProvider.selectedCountry =
                                      country.name;
                                });
                              },
                            );
                          ...
                          child: TextFieldWidget(
                              ...
                              maxlines: 1,
                              hintText:
                                  recruiterJobsProvider.selectedCountry == null
                                      ? "Please Choose"
                                      : recruiterJobsProvider.selectedCountry
                                          .toString(),
                              title: "Job Location",
                        ...
                        InkWell(
                          ...
                          child: TextFieldWidget(
                              ...
                              showtitle: true,
                              hintText:
                                  recruiterJobsProvider.selectedWorkPlace ==
                                          null
                                      ? "Please Choose"
                                      : recruiterJobsProvider.selectedWorkPlace
                                          .toString(),
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                onFieldSubmitted: (val) {
                                  recruiterJobsProvider.addSkillInList(val);
                                  dp(
                                      msg: "on field submitted",
                                      arg: val.toString());
                                  dp(
                                      msg: "skills list",
                                      arg: recruiterJobsProvider.skillsList
                                          .toString());
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintStyle: fontW4S12(context)!.copyWith(
                                        color: AppColors.greyColor,
                                        fontSize: 14),
                        ...
                        if (recruiterJobsProvider.skillsList.isNotEmpty) ...[
                          Container(
                            height: 60,
                            child: ListView.builder(
                                itemCount:
                                    recruiterJobsProvider.skillsList.length,
